...
public class Project {
    ...
    @JsonProperty("url") // Constituye al atributo web_url de GitMiner
    private String url;
    @JsonProperty("html_url")
    private String htmlUrl;
    @JsonProperty("columns_url")
    private String columnsUrl;
    @JsonProperty("id") // Constituye al atributo id de GitMiner
    private Integer id;
    @JsonProperty("node_id")
    private String nodeId;
    @JsonProperty("name") // Constituye al atributo name de GitMiner
    private String name;
    @JsonProperty("body")
    private String body;
    @JsonProperty("number")
