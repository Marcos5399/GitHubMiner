...
package integrationProjectGHM.GitHubMiner.model.user;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;

@JsonIgnoreProperties(ignoreUnknown = true)
// Recuerda, con JsonIgnoreProperties conseguimos que si la response de JSON tiene más campos de los que tenemos en la clase, no nos de error, estos campos de más se ignoran
...
public class User {
    ...
    @JsonProperty("avatar_url") // avatar_url
    private String avatarUrl;
    @JsonProperty("gravatar_id")
    private String gravatarId;
    @JsonProperty("url") //web_url en GitMiner
    private String url;
    ...
    @JsonProperty("name") // name en GitMiner
    private String name;
