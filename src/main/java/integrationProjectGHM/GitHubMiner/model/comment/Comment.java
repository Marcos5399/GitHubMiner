...
package integrationProjectGHM.GitHubMiner.model.comment;
...
public class Comment {
    ...
    @JsonProperty("body")
    private String body;
    @JsonProperty("user") // Este user será la clase definida en la carpeta User
    private User user;
    @JsonProperty("created_at")
    private String createdAt;
    @JsonProperty("updated_at")
    private String updatedAt;
    @JsonProperty("issue_url") // Ojo en el url de la issue se encuentra el id de la issue, para que podamos realizar la asociación
